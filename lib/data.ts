...
export const CASE_STUDIES = [
  {
    ...
    subtitle: "Decomposing monoliths for multi-domain scale",
    challenge:
      "Legacy Django monoliths caused slow deploys, inability to scale individual services, and productivity collapse as client bases and team sizes grew.",
    systemDesign: [
    ...
    scalabilityStrategy:
      "Horizontal scaling via ECS/Kubernetes autoscaling with CloudWatch alarms. Each service independently deployable with blue/green deployments.",
    costOptimization:
  ...
  },
  {
    ...
    subtitle: "One Django backend, three client platforms",
    challenge:
      "ZeroCheating needed to run consistently across React Native (mobile), Electron (desktop), and React (web) while sharing a single Django backend with real-time sync and automated CI/CD.",
    systemDesign: [
      "Shared Django REST API consumed by all three clients",
      "GitHub Actions CI/CD for automated surveillance workflows",
  ...
  },
  {
    ...
    subtitle: "50% faster deploys with zero environment drift",
    challenge:
      "Manual deployments and environment inconsistencies were causing delayed releases, production bugs, and wasted engineering hours across teams.",
    systemDesign: [
      "GitLab CI/CD and GitHub Actions pipelines per service",
      "Docker containerisation for environment consistency",
      "Automated testing gates before every merge",
      "AWS deployment with zero-downtime rolling updates",
    ],
    scalabilityStrategy:
      "Kubernetes orchestration for container scaling. AWS RDS with read replicas for database load. CloudWatch alarms for proactive scaling triggers.",
    costOptimization:
      "Eliminated manual deployment overhead. Automated testing reduced production bug rate by 20%. Environment parity cut debugging time by 60%.",
    icon: "GitBranch",
    color: "purple",
  },
  {
    ...
    subtitle: "30% uptime improvement for enterprise AFC systems",
    challenge:
      "Enterprise IoT clients needed a mission-critical AFC (Automated Frequency Coordination) portal with strict reliability, compliance, and uptime SLAs for US telecommunications regulation.",
    systemDesign: [
      "IoT device integration via REST APIs and message queues",
      "DMVI system with real-time data processing",
      "Compliance-first architecture for US telecom regulation",
      "High-availability deployment on AWS with failover",
    ],
    scalabilityStrategy:
      "AWS auto-scaling groups behind ALB. RabbitMQ for reliable message queuing between IoT devices and processing services.",
    costOptimization:
      "Reserved instances for baseline capacity, spot for burst. Streamlined pipelines reduced deployment time by 50%, freeing engineering hours.",
    icon: "BarChart3",
    color: "emerald",
  },
];
